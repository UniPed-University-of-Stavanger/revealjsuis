# Den norske didaktiske diamanten
### click left or right on keyboard or using the arrows below to navigate

---

## Den norske didaktiske diamanten er en modell som gir en ramme for å forstå de viktigste elementene i undervisning og læring i et klasserom.
## Læreren er det sentrale elementet i den didaktiske diamanten, og er ansvarlig for å lage og implementere en undervisningsplan som støtter studentenes læring. Studentene er fokuset for undervisningen, og deres behov, interesser, og evner må tas i betraktning når man planlegger instruksjon.
## Fagstoffet er innholdet som læreren er ansvarlig for å formidle, og inkluderer kunnskap, ferdigheter, og holdninger som studentene forventes å lære. Læringsmiljøet er den fysiske og sosiale konteksten der undervisning og læring finner sted, og inkluderer den fysiske plassen, de sosiale interaksjonene, og ressursene og materialene som brukes i klasserommet . 
---
